...
void main()
{
	...
	A = mxGetPr(mxCreateDoubleMatrix(n,n,mxREAL));
	B = mxGetPr(mxCreateDoubleMatrix(n,m,mxREAL));
    Q = mxGetPr(mxCreateDoubleMatrix(n,n,mxREAL));
    R = mxGetPr(mxCreateDoubleMatrix(m,m,mxREAL));
    Qf = mxGetPr(mxCreateDoubleMatrix(n,n,mxREAL));
    xmax = mxGetPr(mxCreateDoubleMatrix(n,1,mxREAL));
    xmin = mxGetPr(mxCreateDoubleMatrix(n,1,mxREAL));
    umax = mxGetPr(mxCreateDoubleMatrix(m,1,mxREAL));
    umin = mxGetPr(mxCreateDoubleMatrix(m,1,mxREAL));
    
	X0 = mxGetPr(mxCreateDoubleMatrix(n,1,mxREAL));
    U0 = mxGetPr(mxCreateDoubleMatrix(m,1,mxREAL));
    x0 = mxGetPr(mxCreateDoubleMatrix(n,1,mxREAL));
    ...
    X = mxGetPr(mxCreateDoubleMatrix(n,T,mxREAL));
    U = mxGetPr(mxCreateDoubleMatrix(m,T,mxREAL));
	telapsed = mxGetPr(mxCreateDoubleMatrix(1,1,mxREAL));
